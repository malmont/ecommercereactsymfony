...
border: 2px solid ${(props) => props.theme.colors.cardBorder }; /* Bordure noire */
...
border: 3px solid ${(props) => props.theme.colors.cardAccent};
border-radius: 20px;
...
text-align: center;
background: ${(props) => props.theme.colors.cardBodyBackground };
border-top: 2px solid ${(props) => props.theme.colors.cardAccent };
border-radius: 0 0 20px 20px;
`,
...
border: 3px dashed ${(props) => props.theme.colors.differentCardBorder };
border-radius: 20px;
...
height: 100%;
object-fit: cover;
border-bottom: 2px solid ${(props) => props.theme.colors.cardAccent };
`,
...
`,
  SizeCircle: styled.div`
    ...
    background-color: ${(props) =>
      props.isSelected ? props.theme.colors.blackAccent  : '#f7f7f7'};
    ...
    border: ${(props) =>
      props.isSelected
        ? `3px solid ${props.theme.colors.blackAccent }`
        : '2px solid #ccc'};
    font-weight: bold;
    font-size: 0.8rem;
    transition: all 0.3s ease;
    ...
    &:hover {
      transform: scale(1.1);
      box-shadow: 0 4px 10px ${(props) => props.theme.colors.blackAccent };
    }
  `,
  ...
  CartItem: styled.div`
    ...
    padding: 10px;
    background: ${(props) => props.theme.colors.cardBackground };
    border: 1px solid ${(props) => props.theme.colors.blackAccent };
    border-radius: 6px;
